...
async def run_routersploit(ip: str, output_csv: str, semaphore: Semaphore, buffer):
    async with semaphore:
        ...
        # Collecting and processing the output with refined filtering for confirmed vulnerabilities
        async for line in process.stdout:
            line = line.decode().strip()
            # Only consider lines with specific phrases indicating confirmed vulnerability
